...
December31 <-
  ...
  subset(select = c(1,4,5)) %>%
  rename(c("DeathsPerMillionDecember31" = "DeathsPerMillion")) %>%
  rename(c("CasesPerMillionDecember31" = "CasesPerMillion"))
...
April5 <-
  ...
  subset(select = c(1,4,5)) %>%
  rename(c("DeathsPerMillionApril5" = "DeathsPerMillion")) %>%
  rename(c("CasesPerMillionApril5" = "CasesPerMillion"))
...
WorldMap(GrowthMix, key = country, fill = CasesPerMillionTotalGrowth)
